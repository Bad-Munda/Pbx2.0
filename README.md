...
<p align="center"><img src="https://telegra.ph/file/fd8a6715f04182086b49e.jpg" alt="Bad-Munda"></p>
...
![Github forks](https://img.shields.io/github/forks/Bad-Munda/Pbx2.0?style=social)
![Github Repo stars](https://img.shields.io/github/stars/Bad-Munda/Pbx2.0?style=social)

![Maintenance](https://img.shields.io/badge/Maintained%3F-Yes-white?&style=social&logo=hugo)
![Github license](https://img.shields.io/github/license/Bad-Munda/Pbx2.0?&style=social&logo=Github)
...
1. **Fork & Star this Repo:**
    > Begin by [forking](https://github.com/Bad-Munda/Pbx2.0/fork) and [starring](https://github.com/Bad-Munda/Pbx2.0) this repository on Github.
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/Bad-Munda/Pbx2.0)
...
3. **Clone Github repository:**
   ```bash
   git clone https://github.com/Bad-Munda/PbxPlugin && cd PbxPlugin
   ```
...
This project is licensed under the [MIT License](https://github.com/Bad-Munda/Pbx2.0/-/blob/Bad/LICENSE) —  
Feel free to use, modify, and share it with credit. ❤️

---

<h2 align="center">
  Made with ❤️ by <a href="https://github.com/Bad-Munda">🕊️⃝‌ʙᴀᴅ ❤️ᥫ᭡</a>
</h2>
